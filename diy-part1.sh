...
git clone https://github.com/rufengsuixing/luci-app-syncdial
...
echo 'src-git luci_app_syncdial https://github.com/rufengsuixing/luci-app-syncdial' >>feeds.conf.default
